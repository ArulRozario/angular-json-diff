export const rightJson = {
  ...
  rrrCollection: {
    ...
    name: 'N-Transfer II',
    notationTemplate:
      "<RRR> - II has been registered with the share values <Share(s)>  supported by documents <Document ID(s)> which confirms the transfer for <Declared Value>. The owner resides at <CFG1.Owner's address> and his residence is <CFG1.Address is verified>. His resident type is <CFG1.Address Type> with the address code <CFG1.Address Code>.",
